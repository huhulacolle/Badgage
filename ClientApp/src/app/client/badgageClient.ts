...
export class TaskBadgageClient {
    ...
    getListUserByIdTask(idTask: number): Observable<UserOnTaskModelWithName[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetListUserByIdTask(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetListUserByIdTask(response_ as any);
                } catch (e) {
    ...
    protected processGetListUserByIdTask(response: HttpResponseBase): Observable<UserOnTaskModelWithName[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class TeamBadgageClient {
    ...
    getTeamByIdProject(idProject: number): Observable<TeamModel[]> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTeamByIdProject(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTeamByIdProject(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<TeamModel[]>;
                }
            } else
    ...
    protected processGetTeamByIdProject(response: HttpResponseBase): Observable<TeamModel[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
